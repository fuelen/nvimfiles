...
return function()
    ...
    vim.api.nvim_set_keymap("", "<leader>p", ":NvimTreeToggle<CR>", {noremap = true, desc = "Toggle Files Tree"})
    vim.api.nvim_set_keymap("", "<Space>ff", ":NvimTreeFindFile<CR>", {noremap = true, desc = "Focus cursor on current file"})
